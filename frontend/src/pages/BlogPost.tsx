...
const BLOG_CONTENT: Record<string, { title: string; date: string; author: string; category: string; readTime: string; content: string[] }> = {
  ...
  'iso-27001-audit-preparation': {
    ...
    content: [
      ...
      'Auronix offers a complete ISO 27001 readiness programme that includes gap analysis, policy template library, control implementation guidance, internal audit, and support through the certification process. Our clients have a 100% first-attempt pass rate.',
    ],
  },
  ...
  'cloud-security-aws-azure': {
    ...
    content: [
      ...
      'We recommend monthly cloud security posture assessments and continuous monitoring through a CSPM tool. Auronix\'s cloud security assessment covers all major cloud providers and provides a detailed hardening guide tailored to your specific environment and compliance requirements.',
    ],
  },
  'rbi-cybersecurity-framework-guide': {
    ...
    content: [
      ...
      'Compliance is not optional — non-compliance can result in regulatory action including penalties, business restrictions, and reputational damage. Auronix specialises in RBI compliance and has helped multiple banks achieve full compliance within our engagement timelines.',
    ],
  },
};
