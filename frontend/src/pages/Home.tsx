...
const Home: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-bg">
      {/* ── Section 2: Hero ───────────────────────────────────── */}
      <section className="relative min-h-[100dvh] pt-20 flex flex-col justify-center bg-grid-pattern">
        ...
        <div className="container-custom relative z-10 text-center py-12 lg:py-24">
          {/* Mono label */}
